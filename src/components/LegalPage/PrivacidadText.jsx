      ...
      <article className='mb-5'>
        ...
        <Fade left duration={500} delay={800} distance={'30px'}>
          <div className='text-grey font-small'>
            ...
            <p>
              Mockraft Agency está altamente comprometido para cumplir con el
      ...
      <article className='mb-5'>
        ...
        <Fade left duration={500} delay={800} distance={'30px'}>
          <div className='text-grey font-small'>
            ...
            <p>
              Mockraft Agency Se reserva el derecho de cambiar los términos de
