      ...
      <RichText title='¿Qué es Mockraft?'>
        <>
          <p className='text-grey font-small'>
            ...
            comprometidos en ofrecer soluciones digitales efectivas y de calidad
            que satisfagan las necesidades de nuestros clientes.
          </p>
          <p className='text-grey font-small'>
            Nuestro equipo de trabajo se caracteriza por combinar trayectoria y
            aprendizaje continuo, sumando más de 20 años de experiencia en los
            distintos departamentos.
          </p>
          <p className='text-grey font-small'>
            <em>Mock</em> proviene de la palabra (Mockup), es el plano de
            nuestras ideas, donde definimos nuestra estrategia digital a
            realizar. Mientras que <em>Craft</em> (Crafting), es la acción de
            crear y construir esa idea, cuando juntamos estos 2 términos,
            obtenemos una solución estructurada de manera eficiente, he ahí
            nuestra esencia como Agencia.
          </p>
        </>
      </RichText>
